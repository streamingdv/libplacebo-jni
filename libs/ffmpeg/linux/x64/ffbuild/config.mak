...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-all --disable-gpl --disable-iconv --enable-static --enable-pic --enable-avcodec --enable-avformat --enable-avutil --enable-libdrm --enable-vulkan --enable-vaapi --enable-ffnvcodec --enable-nvdec --enable-cuvid --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=h264_cuvid --enable-decoder=hevc_cuvid --enable-hwaccel=h264_vulkan --enable-hwaccel=hevc_vulkan --enable-hwaccel=h264_vaapi --enable-hwaccel=hevc_vaapi --enable-hwaccel=h264_nvdec --enable-hwaccel=hevc_nvdec --extra-cflags='-fPIC -I/__w/ffmpeg-build/ffmpeg-build/vulkan-headers/include' --extra-ldexeflags=-pie
prefix=/usr/local
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_POSIX_C_SOURCE=200112 -D_XOPEN_SOURCE=600 -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=  -fPIC -I/__w/ffmpeg-build/ffmpeg-build/vulkan-headers/include -std=c17 -fomit-frame-pointer -fPIC   -pthread -I/usr/include/libdrm     -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=format-security -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=   -D__STDC_CONSTANT_MACROS -std=c++17 -fomit-frame-pointer -fPIC -pthread -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
OBJCFLAGS=   -fPIC -pthread -g
ASFLAGS=  -fPIC -I/__w/ffmpeg-build/ffmpeg-build/vulkan-headers/include -fPIC -g
GLSLCFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -latomic -lva -ldl
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lva-drm -lva -lva-x11 -lva -lm -ldrm -lva -latomic -pthread -lX11 -ldl
EXTRALIBS-ffplay=-ldl
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
