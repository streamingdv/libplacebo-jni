...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-all --disable-gpl --disable-iconv --enable-static --enable-pic --enable-avcodec --enable-avformat --enable-avutil --enable-vulkan --enable-d3d11va --enable-dxva2 --enable-ffnvcodec --enable-nvdec --enable-cuvid --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=h264_cuvid --enable-decoder=hevc_cuvid --enable-hwaccel=h264_vulkan --enable-hwaccel=hevc_vulkan --enable-hwaccel=h264_d3d11va --enable-hwaccel=hevc_d3d11va --enable-hwaccel=h264_d3d11va2 --enable-hwaccel=hevc_d3d11va2 --enable-hwaccel=h264_dxva2 --enable-hwaccel=hevc_dxva2 --enable-hwaccel=h264_nvdec --enable-hwaccel=hevc_nvdec --extra-cflags='-fPIC -I../vulkan-headers/include'
prefix=/usr/local
...
CC_IDENT=gcc 16.1.0 (Rev6, Built by MSYS2 project)
ARCH=x86
INTRINSICS=sse2
EXTERN_PREFIX=_
CC=gcc
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,-rpath-link=:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avfilter=-lm -latomic -lz
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-avformat=-lm -lz -latomic -lsecur32 -lncrypt -lcrypt32 -lws2_32
EXTRALIBS-avcodec=-lm -latomic -lz -lole32 -luser32
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-lm -lz -luser32 -lbcrypt -latomic
