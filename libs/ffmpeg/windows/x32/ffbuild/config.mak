...
CC_IDENT=gcc 13.2.0 (Rev3, Built by MSYS2 project)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=_
CC=gcc
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS=  -Wl,--large-address-aware -Wl,--nxcompat,--dynamicbase -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
ASMSTRIPFLAGS= -x
X86ASMFLAGS=-f win32 -DPIC -DPREFIX
MSAFLAGS=
MMIFLAGS=
LSXFLAGS=
LASXFLAGS=
...
EXTRALIBS-avformat=-lm -lws2_32 -lz -latomic
EXTRALIBS-avcodec=-liconv -lm -latomic -lole32 -luser32
